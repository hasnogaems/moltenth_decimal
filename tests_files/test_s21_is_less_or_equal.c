...
START_TEST(s21_test_is_less_or_equal_5) {
  s21_decimal a = {{MAXBITS, MAXBITS - 1, 0, 0}};
...
START_TEST(s21_test_is_less_or_equal_6) {
  ...
  s21_decimal b = {{MAXBITS, MAXBITS, MAXBITS, 0}};
  ck_assert_int_eq(s21_is_less_or_equal(a, b), 1);
}
END_TEST
...
START_TEST(s21_test_is_less_or_equal_8) {
  ...
  s21_decimal b = {{0, MAXBITS, MAXBITS, 0}};
  ck_assert_int_eq(s21_is_less_or_equal(a, b), 1);
}
END_TEST
...
int run_s21_is_less_or_equal() {
  ...
  TCase *tc = tcase_create("case_less_or_equal");
