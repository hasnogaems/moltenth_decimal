...
START_TEST(s21_test_is_greater_4) {
  s21_decimal a = {{MAXBITS, 0, 0, 0}};
  s21_decimal b = {{MAXBITS, 1, 0, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 0);
}
END_TEST

START_TEST(s21_test_is_greater_41) {
  s21_decimal a = {{MAXBITS, 1, 0, 0}};
  s21_decimal b = {{MAXBITS, 0, 0, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST
...
START_TEST(s21_test_is_greater_5) {
  s21_decimal a = {{MAXBITS, MAXBITS, 0, 0}};
  s21_decimal b = {{MAXBITS, MAXBITS - 1, 0, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST
...
START_TEST(s21_test_is_greater_51) {
  s21_decimal a = {{MAXBITS, MAXBITS, 0, 0}};
  s21_decimal b = {{MAXBITS, MAXBITS, 0, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 0);
}
END_TEST

START_TEST(s21_test_is_greater_6) {
  s21_decimal a = {{MAXBITS, MAXBITS, MAXBITS, 0}};
  s21_decimal b = {{MAXBITS, MAXBITS, MAXBITS - 1, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST

START_TEST(s21_test_is_greater_7) {
  s21_decimal a = {{MAXBITS, MAXBITS, MAXBITS - 1, 0}};
  s21_decimal b = {{MAXBITS, MAXBITS, 0, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST
...
START_TEST(s21_test_is_greater_8) {
  s21_decimal a = {{0, MAXBITS, MAXBITS, 0}};
  s21_decimal b = {{0, MAXBITS, MAXBITS - 1, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST

START_TEST(s21_test_is_greater_9) {
  s21_decimal a = {{0, 0, MAXBITS, 0}};
  s21_decimal b = {{0, 0, MAXBITS - 1, 0}};
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST
