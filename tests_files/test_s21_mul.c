...
START_TEST(s21_mul_3) {
  // -48372495492579772208200
  s21_decimal dec_1 = {{0x417a1448, 0x473a6a09, 0xa3e, 0x80000000}};
  // -58.2678649441
  s21_decimal dec_2 = {{0xaa5a9a61, 0x87, 0x0, 0x800a0000}};
  // 2818562034370724170722940.2266
  s21_decimal dec_check = {{0x153bd49a, 0x799664e5, 0x5b129944, 0x40000}};
  s21_decimal result;
  int return_value = s21_mul(dec_1, dec_2, &result);
  ck_assert_int_eq(return_value, 0);
  ck_assert_uint_eq(dec_check.bits[0], result.bits[0]);
